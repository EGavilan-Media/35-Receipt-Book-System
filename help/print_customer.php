...
class PDF extends FPDF {
	function Header(){
		...
		$this->Cell(55,10,'Name',1,0,'',true);
		$this->Cell(55,10,'Email',1,0,'',true);
		$this->Cell(40,10,'Telephone',1,0,'',true);
		$this->Cell(20,10,'Status',1,1,'',true);
...
$query = mysqli_query($connect,"SELECT * FROM tbl_customers");

while($data = mysqli_fetch_array($query)){
	$pdf->Cell(10,5,$data[0],1,0);
	$pdf->Cell(55,5,$data[3],1,0);
	$pdf->Cell(55,5,$data[4],1,0);
	$pdf->Cell(40,5,$data[6],1,0);
	$pdf->Cell(20,5,$data[7],1,1);
}

$pdf->Output('I','Customer List.pdf');
?>
